...
Retrieved 2026-08-30. Spark Plug uses these marks only to identify compatible
...
| --- | --- | --- | --- | --- |
| `public/integrations/openclaw.svg` | OpenClaw | `PaperclipAI/paperclip`, `doc/assets/logos/openclaw.svg` | Referential brand use; upstream repository license does not grant trademark rights | None |
| `public/integrations/hermes.png` | Nous Research | `NousResearch/hermes-agent`, `website/static/img/logo.png` | MIT repository; trademark rights separate | None; exact local source copy |
