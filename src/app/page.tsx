...
const faqs = [
  ...
  ["Does every request leave my network?", "No. Local clients, GW Broker, models, telemetry, and logs can stay on your node. Optional cloud routes, Rabbit transport, and this site’s Sketchfab viewer have separate disclosed boundaries."],
