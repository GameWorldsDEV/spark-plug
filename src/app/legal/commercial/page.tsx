...
export default function CommercialTermsPage() {
  return <LegalShell eyebrow="COMMERCIAL TERMS / NOT YET EFFECTIVE" title="No subscription or sale goes live on unfinished promises." summary="The planned Pro service and creator marketplace remain disabled until billing, seller, buyer, privacy, moderation, security, and support terms are complete and tested.">
    ...
    <h2>Creator marketplace</h2><p>Active Pro creators may apply to publish approved free or paid profiles, themes, motion packs, and rights-cleared LoRA adapters. Seller onboarding, platform fees, payment fees, payout timing, reserves, refunds, disputes, taxes, content licenses, takedowns, and account termination require explicit terms before activation.</p>
    ...
    <h2>Activation rule</h2><p>Commercial mode requires both the Commercial launch stage and a separate server-only readiness switch. Neither may be enabled until test-mode transactions, adversarial authorization tests, moderation operations, rate limits, legal review, and owner approval pass.</p>
  </LegalShell>;
}
