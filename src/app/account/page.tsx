...
export default function AccountPage() {
  ...
  return <LegalShell eyebrow={`${currentLaunch.stage.toUpperCase()} / OPTIONAL ACCOUNT`} title={accountHref ? "Sign in through the private marketplace service." : "Accounts are not active in Preview."} summary="Community local operation never requires an account. Commercial accounts exist only for optional Pro presentation and hosted conveniences.">
    ...
    {accountHref ? <p><a href={accountHref}>Continue to the private Spark Plug marketplace account ↗</a></p> : <p><strong>Coming with the Commercial stage.</strong> No sign-in request is accepted by the Preview deployment.</p>}
